    ...
    return (
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="bg-muted p-4 rounded-lg">
          ...
          {netBalance === 0 ? (
            <p>You are all settled up with {otherUser.username || otherUser.email || "Unknown"}</p>
          ) : netBalance > 0 ? (
            <div className="flex justify-between items-center">
              <p>
                <span className="font-medium">{otherUser.username || otherUser.email || "Unknown"}</span> owes you
              </p>
            ...
            <div className="flex justify-between items-center">
              <p>
                You owe <span className="font-medium">{otherUser.username || otherUser.email || "Unknown"}</span>
              </p>
              ...
              <Label htmlFor="youPaid" className="flex-grow cursor-pointer">
                <div className="flex items-center">
                  <Avatar className="h-6 w-6 mr-2">
                    ...
                    <AvatarFallback>
                      {(currentUser.username && currentUser.username.charAt(0)) || (currentUser.email && currentUser.email.charAt(0)) || "?"}
                    </AvatarFallback>
                  </Avatar>
                  <span>You paid {otherUser.username || otherUser.email || "Unknown"}</span>
                </div>
              </Label>
            </div>
              ...
              <Label htmlFor="theyPaid" className="flex-grow cursor-pointer">
                <div className="flex items-center">
                  <Avatar className="h-6 w-6 mr-2">
                    ...
                    <AvatarFallback>
                      {(otherUser.username && otherUser.username.charAt(0)) || (otherUser.email && otherUser.email.charAt(0)) || "?"}
                    </AvatarFallback>
                  </Avatar>
                  <span>{otherUser.username || otherUser.email || "Unknown"} paid you</span>
                </div>
              </Label>
            </div>
          </RadioGroup>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium">{member.username || member.email || "Unknown"}</span>
                    </div>
                    <div
                      ...
                      <Avatar className="h-6 w-6 mr-2">
                        ...
                        <AvatarFallback>
                          {(groupMembers
                            ...
                            .find((m) => m.userId === selectedGroupMemberId)
                            ?.username.charAt(0)) || (groupMembers
                            .find((m) => m.userId === selectedGroupMemberId)
                            ?.email && groupMembers
                            .find((m) => m.userId === selectedGroupMemberId)
                            ?.email.charAt(0)) || "?"}
